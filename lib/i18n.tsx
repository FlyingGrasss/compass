...
const messages: Record<Locale, Record<string, string>> = {
  tr: {
    ...
    "profile.eligibilityDescription": "Yaş ve sınıf bilgilerinizi girerek size uygun programları birlikte bulabilirsiniz.",
  ...
  en: {
    ...
    "profile.eligibilityDescription": "Add your age and grade to find programs that fit you.",
