...
const messages: Record<Locale, Record<string, string>> = {
  tr: {
    ...
    "home.findMatches": "Bana Uygun Programları Bul",
    ...
    "activities.ageWord": "Yaş",
    "activities.age": "Yaş",
    "activities.location": "Konum",
    "activities.allLocations": "Tüm Konumlar",
    "activities.allAges": "Tüm Yaşlar",
    "activities.forMe": "Bana Uygun Programları Göster",
    "activities.completeProfile": "Bana uygun programları görmek için profilinizde yaş veya sınıf bilgisi ekleyin.",
    ...
    "auth.signInError": "Giriş yapılamadı. Lütfen tekrar deneyin.",
    ...
    "profile.eligibilityTitle": "Program eşleştirme bilgileriniz",
    "profile.eligibilityDescription": "Yaş, sınıf ve konum tercihlerinizi girerek size uygun programları birlikte bulabilirsiniz.",
    "profile.age": "Yaş (opsiyonel)",
    "profile.grade": "Sınıf (opsiyonel)",
    "profile.locations": "Konum tercihleri (opsiyonel)",
    "profile.locationsDescription": "Birden fazla seçenek seçebilirsiniz. Çevrimiçi programlar ayrıca işaretlenir.",
    "profile.notSpecified": "Belirtilmedi",
    "profile.agePlaceholder": "Örn. 16",
    "profile.save": "Bilgileri Kaydet",
    "profile.saving": "Kaydediliyor...",
    "profile.updated": "Profil bilgileriniz güncellendi",
    "profile.findMatches": "Bana Uygun Programları Bul",
  },
  en: {
    "brand.name": "YouthCompass",
    ...
    "home.findMatches": "Find Programs For Me",
    ...
    "activities.ageWord": "Age",
    "activities.age": "Age",
    "activities.location": "Location",
    "activities.allLocations": "All locations",
    "activities.allAges": "All Ages",
    "activities.forMe": "Show Programs For Me",
    "activities.completeProfile": "Add your age or grade in your profile to see programs that fit you.",
    ...
    "auth.signInError": "Unable to sign in. Please try again.",
    ...
    "profile.eligibilityTitle": "Your program matching details",
    "profile.eligibilityDescription": "Add your age, grade, and location preferences to find programs that fit you.",
    "profile.age": "Age (optional)",
    "profile.grade": "Grade (optional)",
    "profile.locations": "Location preferences (optional)",
    "profile.locationsDescription": "You can choose more than one. Online opportunities are tagged separately.",
    "profile.notSpecified": "Not specified",
    "profile.agePlaceholder": "e.g. 16",
    "profile.save": "Save details",
    "profile.saving": "Saving...",
    "profile.updated": "Profile details updated",
    "profile.findMatches": "Find Programs For Me",
  },
}
